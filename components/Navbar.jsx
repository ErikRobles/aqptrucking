...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="z-30 bg-gradient-to-br from-[#00388d] via-[#592057] to-[#d2000a] w-[100%] h-[110px] fixed top-0 left-0 text-white shadow-lg shadow-black/30 text-xl p-3">
