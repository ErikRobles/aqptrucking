    ...
    <>
      <div className="mb-[30px]">
        ...
        <div className="relative">
          {buttonClicked && (
            <>
              <div className="fixed inset-0 z-30 bg-black bg-opacity-75"></div>

              <div className="fixed inset-0 z-60 overflow-y-auto">
                <div className="flex mt-[110px] max-h-fulll items-center justify-center p-4 text-center sm:items-center sm:p-0">
                  <div className="max-w-xl p-2 mx-auto my-3 bg-white rounded-md shadow-sm">
                    <div className="text-center">
                      <h1 className="my-1 text-2xl font-semibold text-gray-700">
                    ...
                    <div>
                      <form onSubmit={cvSubmit} encType="multipart/form-data">
                        ...
                        <div className="mb-2 flex flex-row justify-evenly align-center">
                          {blockOneOpen && (
                            <button
                              type="button"
                              className="btn btn-primary min-w-[85px] bg-[#d2000a] hover:bg-[#b1010a] text-white py-2 px-4 rounded-md shadow-lg"
                          ...
                          {!blockOneOpen && (
                            <button
                              type="button"
                              className="btn btn-primary min-w-[85px] bg-[#d2000a] hover:bg-[#b1010a] text-white py-2 px-4 rounded-md disabled:opacity-25 shadow-lg"
                          ...
                          <button
                            type="button"
                            className="btn btn-primary min-w-[85px] bg-[#00388d] hover:bg-[#01275f] text-white py-2 px-4 rounded-md disabled:opacity-25 shadow-lg"
                            onClick={() => setBlockOneOpen(!blockOneOpen)}
                          >
                            Next
                          </button>
